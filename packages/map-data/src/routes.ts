 ...
 * flag: '' | 'D-A'..'D-M' (double-route pair) | 'T' (tunnel) | 'F1'/'F2'/'F3' (ferry loco count).
...
const ROWS: readonly Row[] = [
  ...
  ['R36', 'yuli', 'chishang', 'BLUE', 1, ''],
  ['R37', 'chishang', 'taitung', 'ORANGE', 2, ''],
  ['R38', 'kaohsiung', 'pingtung', 'ORANGE', 1, ''],
  ['R39', 'tainan', 'pingtung', 'GREEN', 4, ''],
  ['R40', 'taitung', 'pingtung', 'PURPLE', 4, ''],
  ['R41', 'taitung', 'chaozhou', 'BLUE', 4, '', -1.9],
  ['R42', 'pingtung', 'chaozhou', 'GRAY', 1, ''],
  ['R43', 'taichung', 'changhua', 'RED', 2, 'D-L'],
  ['R44', 'hsinchu', 'zhunan', 'WHITE', 1, 'D-F'],
  ['R45', 'hsinchu', 'zhunan', 'ORANGE', 1, 'D-F'],
  ...
  ['R58', 'chaozhou', 'hengchun', 'YELLOW', 3, ''],
  ['R59', 'kaohsiung', 'liuqiu', 'GRAY', 2, ''],
  ['R60', 'liuqiu', 'hengchun', 'PURPLE', 3, ''],
  ['R61', 'hengchun', 'orchidisland', 'GRAY', 4, 'F2'],
  ['R62', 'luodong', 'hualien', 'RED', 4, 'D-J'],
  ['R63', 'luodong', 'hualien', 'BLUE', 4, 'D-J'],
  ['R64', 'huwei', 'douliu', 'PURPLE', 1, ''],
  ['R65', 'taipei', 'pingxi', 'WHITE', 2, ''],
  ['R66', 'pingxi', 'yilan', 'GRAY', 2, 'T'],
  ['R67', 'keelung', 'pingxi', 'ORANGE', 2, ''],
  ['R68', 'liuqiu', 'chaozhou', 'WHITE', 2, '', 0.1],
  ['R69', 'yuli', 'greenisland', 'GRAY', 4, 'F2'],
  ['R70', 'zuoying', 'kaohsiung', 'BLUE', 1, 'D-K'],
  ['R71', 'tainan', 'zuoying', 'BLACK', 2, 'D-A'],
  ['R72', 'zuoying', 'kaohsiung', 'RED', 1, 'D-K'],
  ['R73', 'tainan', 'zuoying', 'GRAY', 2, 'D-A'],
  ['R74', 'kinmen', 'changhua', 'GRAY', 6, 'F2'],
  ['R75', 'shalu', 'matsu', 'GRAY', 8, 'F3'],
  ['R76', 'alishan', 'chishang', 'GRAY', 3, 'T'],
  ['R77', 'taichung', 'changhua', 'BLACK', 2, 'D-L'],
  ['R78', 'nantou', 'jiji', 'YELLOW', 1, 'D-M'],
];
