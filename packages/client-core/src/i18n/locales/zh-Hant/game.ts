...
export default {
  ...
  seatNumber: '第 {{n}} 席',
  currentScore: '目前分數',
  scoreFromRoutes: '已鋪路線',
  trainSupply: '車廂存量',
  endgameSoon: '即將觸發終局',
  network: '路網',
  networkRoutes: '已占領 {{count}} 條路線',
  networkStations: '車站設於 {{cities}}',
  networkNoStations: '尚未建站',
  showNetwork: '在地圖上顯示路網',
  hideNetwork: '隱藏路網',
  publicInfo: '公開',
  noCompletedTickets: '尚未完成任務',
  eventResources: '事件資源',
  ...
  teamPool: '隊伍牌池',
  teamPoolEmpty: '牌池是空的',
  teamPoolCount: '{{n}} / {{max}} 張',
  teamPoolHint: '每回合可免費放入一張牌；拿取則算作一次抽牌。',
  teamPoolPush: '放入牌池',
  teamPoolTake: '取出',
  teamPoolPushUsed: '本回合已放過牌了',
  teamPoolFull: '牌池已滿',
  teamPartnerTickets: '隊友任務',
  teamPartnerTicketsEmpty: '隊友尚未保留任務卡',
  teamScoreboard: '隊伍積分',
  teamTallyLead: '{{team}}領先 {{n}} 分',
  teamTallyLevel: '勢均力敵',
  teamTallyShare: '{{team}}：{{n}} 分，全場共 {{total}} 分',
  teamTotal: '隊伍總分',
  teamCombinedTrail: '合併最長路線',
  dockTeam: '隊伍',
};
