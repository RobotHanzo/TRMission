...
export default {
  ...
  createGame: '建立第一場遊戲',
  finalTitle: '教學完成！',
  finalBody: '你已經學會鐵島企劃的所有規則。建立你的第一場遊戲，開始與好友或機器人對戰吧！',

  welcome: {
    title: '歡迎',
    blurb: '遊戲目標與基本概念。',
    goal: '歡迎來到鐵島企劃！在台灣的鐵道網上搶占路線、完成祕密任務卡，得分最高者獲勝。',
  ...
  special: {
    title: '特殊路線',
    blurb: '雙線、渡輪與隧道的規則。',
    intro: '本作的路線分成三種：一般鐵路、跨海渡輪與穿山隧道。下面比較它們的外觀：',
    double:
      '雙線路線：兩座城市之間有兩條平行線。2–3 人時，一條被占下、另一條就鎖住；4–5 人時兩條都可用。同一方只能佔用同組中的一條——組隊模式下，隊友佔下的那條也算你的。',
  ...
  stations: {
    ...
    what: '蓋車站的方法：在地圖上點選一座城市、支付火車牌即可蓋站。結算時，車站可「借用」該城所有對手的路線來幫忙連通任務卡。每座城市只能有一個車站。組隊模式中同隊共用車站——隊友蓋的車站也能為你借用，但每座車站仍然只借一條路線給全隊。',
