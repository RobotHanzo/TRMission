...
export interface RoomMember {
  ...
  seat: number;
  ready: boolean;
  /** OAuth profile picture, when the account has one (absent for guests, bots, and password
   *  accounts). Public alongside the display name — both are already shown at the table. */
  avatarUrl?: string;
  isBot?: boolean;
