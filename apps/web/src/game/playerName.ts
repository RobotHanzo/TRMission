 ...
 * picture at the table exactly as everyone else does. A blocked player's picture is suppressed
 * for the same reason their name is: it is UGC, and showing it would undo the masking.
 */
