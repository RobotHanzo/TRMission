// Country-level land outlines for the map builder's "pick countries" crop mode: Natural Earth
// 1:110m admin-0 country polygons (public domain, https://www.naturalearthdata.com/), simplified
// with the same Douglas-Peucker algorithm as geo/simplify.ts (tolerance 0.03°, rounded to
