// Ported verbatim from apps/web/src/hooks/useAnimationDriver.ts — store-to-store logic with no
// DOM dependency; only the import paths change.
...
/**
 * Single animation driver, mounted once in GameStage. Two reactions:
