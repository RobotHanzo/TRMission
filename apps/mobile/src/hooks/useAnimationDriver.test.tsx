// Ports the web useAnimationDriver test: the driver is store-to-store logic, so the assertions
// (fanfare seeding, endgame warning edge, market reveal, batch→intent, forced re-draw notice)
// carry over verbatim — only the render harness is react-native.
