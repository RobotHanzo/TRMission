...
// zoomBucket lives in ../board/camera (the calibrated single source shared with the board);
// re-export it here so label-tier code keeps one import site. Thresholds are identical.
