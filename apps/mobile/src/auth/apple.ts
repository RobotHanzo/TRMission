...
/**
 * Sign in with Apple on ANDROID (iOS keeps the native expo-apple-authentication credential path):
 * Apple has no Android SDK, so we run the server's SIWA redirect flow in a system browser and hand
