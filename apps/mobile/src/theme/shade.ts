// Tiny deterministic colour helpers for deriving the shading used by the original train-car
// artwork (verbatim port of apps/web/src/theme/shade.ts). Pure hex maths so it renders
// identically everywhere and is independent of the app theme.
