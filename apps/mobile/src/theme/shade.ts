...
// derives from a colour token (verbatim port of apps/web/src/theme/shade.ts). Pure hex maths so
// it renders identically everywhere and is independent of the app theme.
//
